...
//timer
	...
	(function timer() {
		const deadline = new Date(Date.now() + (770 * 60 * 1000 + 999));
	...
	(function timer() {
		const deadline1 = new Date(Date.now() + (770 * 60 * 1000 + 999));
	...
	(function timer() {
		const deadline2 = new Date(Date.now() + (770 * 60 * 1000 + 999));
	...
	(function timer() {
		const deadline3 = new Date(Date.now() + (770 * 60 * 1000 + 999));
...
// calculator
let input = document.querySelectorAll('.form-calculator__input');
...
input.oninput = function() {
	if (square.value !='' && thickness.value !='') {
...
let sliderFirst = new Swiper('.slider-1__body', {
...
let sliderSecond = new Swiper('.slider-2__body_1', {
...
let sliderSecond_2 = new Swiper('.slider-2__body', {
	...
	//loop: true,
	navigation: {
		nextEl: '.slider-2__button-next',
		prevEl: '.slider-2__button-prev',
	},
	thumbs: {
		swiper: sliderSecond,
	},
